...
def test_group_with_skip_range(
    ...
    content = directive_style.markup_separator.join(
        [
            ...
            directive_style.builder(directive="group", argument="start"),
            language.code_block_builder(code="x = [*x, 1]", language="python"),
            directive_style.builder(directive="skip", argument="start"),
            language.code_block_builder(code="x = [*x, 2]", language="python"),
            language.code_block_builder(code="x = [*x, 3]", language="python"),
            directive_style.builder(directive="skip", argument="end"),
            language.code_block_builder(code="x = [*x, 4]", language="python"),
            directive_style.builder(directive="group", argument="end"),
            language.code_block_builder(code="x = [*x, 5]", language="python"),
        ]
...
def test_no_argument(
    ...
    content = directive_style.markup_separator.join(
        [
            directive_style.builder(directive="group"),
            directive_style.builder(directive="group", argument="end"),
        ]
    )
    test_document = tmp_path / "test"
...
def test_end_only(
    ...
    """
    language, directive_style = language_directive_style
    content = directive_style.builder(directive="group", argument="end")
    test_document = tmp_path / "test"
    test_document.write_text(
        data=f"{content}{directive_style.markup_separator}",
        encoding="utf-8",
...
def test_start_only(
    ...
    """
    language, directive_style = language_directive_style
    content = directive_style.builder(directive="group", argument="start")
    test_document = tmp_path / "test"
    test_document.write_text(
        data=f"{content}{directive_style.markup_separator}",
        encoding="utf-8",
...
def test_directive_name_not_regex_escaped(
    ...
    content = directive_style.markup_separator.join(
        [
            language.code_block_builder(code="x = []", language="python"),
            directive_style.builder(directive=directive, argument="start"),
            language.code_block_builder(code="x = [*x, 1]", language="python"),
            language.code_block_builder(code="x = [*x, 2]", language="python"),
            directive_style.builder(directive=directive, argument="end"),
            language.code_block_builder(code="x = [*x, 3]", language="python"),
            directive_style.builder(directive=directive, argument="start"),
            language.code_block_builder(code="x = [*x, 4]", language="python"),
            language.code_block_builder(code="x = [*x, 5]", language="python"),
