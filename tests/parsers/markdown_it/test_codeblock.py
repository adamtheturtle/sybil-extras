...
class TestLanguageMatching:
    """
    Tests for language matching in code blocks.
    """

    def test_language_with_extra_info(self, tmp_path: Path) -> None:
...
class TestBoundsChecking:
    """
    Tests for bounds checking in line offset access.
    """

    def test_unclosed_fence_no_trailing_newline(self, tmp_path: Path) -> None:
